...
public class DBConstants {
    ...
    //add a query to get the count of tickets
    public static final String GET_NB_TICKET = "select count(*) from ticket t where t.VEHICLE_REG_NUMBER=? and OUT_TIME is not null";
